...
const SunriseAndSetCard = () => {
    ...
    if (!weatherData) {
        return (
            <div className="bg-(--surface-color1) w-full h-full lg:w-71.5 rounded-2xl border border-(--border-color) p-3">
    ...
    return (
        <div className="relative flex flex-col items-center w-full h-71.5 lg:w-71.5 lg:h-full p-3 border border-(--border-color) rounded-2xl bg-(--surface-color1) transition-colors duration-200 ease-linear shadow-(--box-shadow)">

            <span className="w-full text-(--color) font-medium text-lg mb-3 transition-colors duration-200 ease-linear">Sunrise & Sunset</span>

            <div
                className="flex items-center justify-center relative border-t-2 border-x-2 border-(--secondary-border) bg-linear-to-b from-0% from-(--secondary-color1) to-transparent rounded-t-full mt-auto mb-4"
                style={{
                    width: 240,
                    height: 120,
                    // bottom: 0,
            ...
            <div
                className="absolute flex items-center w-7 h-7 justify-center z-10 rounded-full transition-all duration-200 ease-out transform translate-x-[110%] lg:translate-x-[40%] translate-y-[195%] lg:translate-y-[195%]"
                style={{
                    left: `${x}px`,
                    top: `${y}px`,
            ...
            >
                ...
                <div className="lg:opacity-0 lg:hover:opacity-100 absolute z-10 rounded-xl border border-(--border-color) shadow-[--box-shadow] w-fit text-center flex items-center bg-(--surface-color1) p-2 justify-center origin-center -left-5 -top-9 transition-all duration-200 ease-linear">

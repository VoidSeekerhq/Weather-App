...
const ForecastCard = (props) => {
    ...
    return (
        <>
            ...
            <nav className='w-full transition-colors duration-200 ease-linear bg-(--bg2) p-1 flex flex-row justify-around items-center rounded-full mb-5'>
            ...
            <ul className='text-sm w-full h-full flex flex-col transition-colors duration-200 ease-linear font-normal gap-4'>

                {props.weekly.map((item) => {
                    const bar = getTempBar(item);

                    return (
                        <li className='w-full grid grid-cols-[80px_auto_40px_1fr_40px] items-center justify-between transition-colors duration-200 ease-linear'>
                            ...
                            <div className="bar bg-(--bg2) w-full h-1 rounded-full relative transition-colors duration-200 ease-linear">
                                <div className="bar-thumb bg-(--thumb) w-5/6 h-1 rounded-full relative transition-colors duration-200 ease-linear"
                                    style={{
                                        left: bar.left,
                                        width: bar.width
                                    }}

        ...
        <div className='lg:sticky lg:top-0 lg:left-0 lg:z-20'>
            <div className='flex flex-col lg:flex-row bg-(--surface-color1) w-dvw p-4 justify-between items-center border-b border-(--border-color) shadow-(--box-shadow) transition-colors duration-200 ease-linear gap-4 z-10 sticky top-0 left-0'>
                ...
                <div className='lg:flex lg:flex-row lg:gap-2 lg:relative lg:right-60'>
                    <div
                        className="theme-btn lg:static absolute right-4 top-4 rounded-full border border-(--border-color) flex items-center justify-center p-1 transition-colors duration-200 ease-linear hover:bg-(--hover)"
                        onClick={handleTheme}
                    >
                        {props.theme === "light"
                    ...
                    <button
                        className="location-btn flex items-center justify-center lg:static absolute left-4 top-4 rounded-full border border-(--border-color) p-1 hover:bg-(--hover) transition-colors duration-200 ease-linear"
